...
(
    ...
    shots_shot_id bigint not null unique
);
create table ship
(
...
alter table if exists game_shots
    add constraint FKtmtu5m5easoq8lika3j1c3chk foreign key (shots_shot_id) references shot;
alter table if exists game_shots
    add constraint FKp373xw3oymfisqpeqsv9u8brl foreign key (game_game_id) references game;
